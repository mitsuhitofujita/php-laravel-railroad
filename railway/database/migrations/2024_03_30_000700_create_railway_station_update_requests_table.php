...
return new class extends Migration
{
    ...
    {
        Schema::create('railway_station_update_requests', function (Blueprint $table) {
            $table->id();
            $table->text('token')->unique('railway_station_update_request_1');
    ...
    {
        Schema::dropIfExists('railway_station_update_requests');
    }
};
