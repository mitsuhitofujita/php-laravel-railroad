...
return new class extends Migration
{
    ...
    {
        Schema::create('railway_line_update_requests', function (Blueprint $table) {
            $table->id();
            $table->text('token')->unique('railway_line_update_request_1');
    ...
    {
        Schema::dropIfExists('railway_line_update_requests');
    }
};
